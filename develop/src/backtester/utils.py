...
class Position:
    def __init__(self, asset, side, qty, entry_price, entry_at, is_exited=False):
        self.asset = asset
        self.side = side
        self.qty = qty
    ...
    def __repr__(self):
        return f"Position(asset={self.asset}, side={self.side}, qty={self.qty}, entry_price={self.entry_price:.4f}, is_exited={str(self.is_exited)})"
