...
V1_SET1 = OrderedDict(
    dict(
        ...
        achieve_ratio=[1, 2],
        achieved_with_commission=[False, True],
        min_holding_minutes=[1, 10],
        ...
        entry_qby_threshold=[6, 7, 8, 9],
        entry_qay_prob_threshold=[0, 0.25, 0.4],
        entry_qby_prob_threshold=[0, 0.25, 0.4, 0.5],
